    ...
    <main className="pt-20">
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4">
          ...
          <h1 id="services-page-heading" className="text-4xl md:text-5xl font-bold text-cream font-devanagari mb-4">
            {t(sv.heading)}
          </h1>
          <p className="text-cream/70 font-devanagari">{t(sv.subheading)}</p>
      ...
      >
        <div className="relative z-10 max-w-2xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-cream font-devanagari mb-4">
            {t({ hi: 'आज ही अपनी पूजा बुक करवाएं', en: 'Book Your Puja Today' })}
          </h2>
          <p className="text-cream/80 font-devanagari mb-6">
          ...
          <a
            ...
            className="btn-gold font-devanagari text-lg px-10 py-4"
          >
